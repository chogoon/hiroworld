...
import static kr.co.within.hiroworld.ui.view.NewCollapsingTextHelper.constrain;

/**
 * Created by chogoon on 2017-09-06.
 */

public class NewCollapsingToolbarLayout extends FrameLayout {
        ...
        final NewCollapsingTextHelper mCollapsingTextHelper;
    ...
    public NewCollapsingToolbarLayout(Context context) {
        this(context, null);
    }

    public NewCollapsingToolbarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewCollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        ThemeUtils.checkAppCompatTheme(context);

        mCollapsingTextHelper = new NewCollapsingTextHelper(this);
        ...
        if (parent instanceof AppBarLayout) {
            ...
            if (mOnOffsetChangedListener == null) {
                mOnOffsetChangedListener = new NewCollapsingToolbarLayout.OffsetUpdateListener();
            }
    ...
    private void updateDummyView() {
        ...
        if (mCollapsingTitleEnabled && mToolbar != null) {
            ...
            if (mDummyView.getParent() == null) {
                mToolbar.addView(mDummyView, NewCollapsingToolbarLayout.LayoutParams.MATCH_PARENT, NewCollapsingToolbarLayout.LayoutParams.MATCH_PARENT);
            }
        }
    }
    ...
    void setScrimAlpha(int alpha) {
        if (alpha != mScrimAlpha) {
            ...
            mScrimAlpha = alpha;
            ViewCompat.postInvalidateOnAnimation(NewCollapsingToolbarLayout.this);
        }
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof NewCollapsingToolbarLayout.LayoutParams;
    }

    @Override
    protected NewCollapsingToolbarLayout.LayoutParams generateDefaultLayoutParams() {
        return new NewCollapsingToolbarLayout.LayoutParams(NewCollapsingToolbarLayout.LayoutParams.MATCH_PARENT, NewCollapsingToolbarLayout.LayoutParams.MATCH_PARENT);
    }

    @Override
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new NewCollapsingToolbarLayout.LayoutParams(getContext(), attrs);
    }

    @Override
    protected FrameLayout.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new NewCollapsingToolbarLayout.LayoutParams(p);
    }
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
         ...
         * {@link NewCollapsingToolbarLayout}.
         */
    ...
    final int getMaxOffsetForPinChild(View child) {
        ...
        final NewCollapsingToolbarLayout.LayoutParams lp = (NewCollapsingToolbarLayout.LayoutParams) child.getLayoutParams();
        return getHeight()
        ...
        public void onOffsetChanged(AppBarLayout layout, int verticalOffset) {
            ...
            for (int i = 0, z = getChildCount(); i < z; i++) {
                ...
                switch (lp.mCollapseMode) {
                    case NewCollapsingToolbarLayout.LayoutParams.COLLAPSE_MODE_PIN:
                        offsetHelper.setTopAndBottomOffset(
                                constrain(-verticalOffset, 0, getMaxOffsetForPinChild(child)));
                        break;
                    case NewCollapsingToolbarLayout.LayoutParams.COLLAPSE_MODE_PARALLAX:
                        offsetHelper.setTopAndBottomOffset(
            ...
            final int expandRange = getHeight() - ViewCompat.getMinimumHeight(
                    NewCollapsingToolbarLayout.this) - insetTop;
